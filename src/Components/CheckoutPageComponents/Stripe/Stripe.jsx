...
const SubmitBtn = ({ processing, error, children, disabled }) => (
  <button
    className={`SubmitBtn ${error ? 'SubmitButton--error' : ''}`}
    type='submit'
...
const Stripe = props => {
  ...
  return paymentMethod ? (
    ...
    <form className='Form' onSubmit={handleSubmit}>
      ...
      <SubmitBtn processing={processing} error={error} disabled={!stripe}>
        Pay $25
      </SubmitBtn>
    </form>
  );
